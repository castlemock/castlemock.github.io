...
The <a href="https://github.com/castlemock/castlemock">GitHub repository</a> remains available for reference, but we recommend exploring alternatives for active use. The <a href="https://hub.docker.com/r/castlemock/castlemock">Docker Hub repository</a> will also be deprecated and eventually deleted.
